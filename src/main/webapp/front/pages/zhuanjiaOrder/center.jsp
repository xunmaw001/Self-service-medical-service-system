    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhuanjiaOrderUuidNumber" id="zhuanjiaOrderUuidNumber" lay-verify="required" placeholder="号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhuanjiaOrderYuyueTypes" id="zhuanjiaOrderYuyueTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`zhuanjiaOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
