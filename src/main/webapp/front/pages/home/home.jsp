        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in zhuanjiaList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../zhuanjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.zhuanjiaPhoto?item.zhuanjiaPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.zhuanjiaName}}</span>
                                                <br/>
                                                <span v-if="item.zhuanjiaNewMoney">
                                                    {{item.zhuanjiaNewMoney}} RMB
                                                </span>
                                                <span v-else>
                                                    {{item.zhuanjiaValue}}
                                                </span>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`zhuanjia/list`, 'get', {
            ...
            vue.zhuanjiaList = res.data.list;
        });
    });
</script>
