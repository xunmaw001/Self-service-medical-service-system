            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">专家展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhuanjiaName" id="zhuanjiaName" placeholder="专家姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in dataList" v-bind:key="index" class="effect-bubba">
                            <img :src="item.zhuanjiaPhoto?item.zhuanjiaPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                            <figcaption>
                                <h2><span>{{item.zhuanjiaName}}</span></h2>
                                <p v-if="item.zhuanjiaNewMoney != null" >￥{{item.zhuanjiaNewMoney}}</p>
                                <a @click="jumpCheck('../zhuanjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >View more</a>
                            </figcaption>
                        </figure>
                    </div>
                    <nav class="pages">
...
<script>
    ...
    // 当前表的字典表
        ...
        function keshiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=keshi_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#zhuanjiaName').val() != null && jquery('#zhuanjiaName').val() != "" && jquery('#zhuanjiaName').val() != "null" ) {
                param['zhuanjiaName'] = jquery('#zhuanjiaName').val();
            }
                                         
            var keshiTypes = $("#keshiTypes").find("option:selected").val();
            if (keshiTypes != null && keshiTypes != "" && keshiTypes != "null") {
            ...
            // 获取列表数据
            http.request('zhuanjia/list', 'get', param, function(res) {
