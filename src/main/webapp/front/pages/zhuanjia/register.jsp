            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">专家姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhuanjiaName" id="zhuanjiaName"  placeholder="专家姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">专家手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhuanjiaPhone" id="zhuanjiaPhone"  lay-verify="phone|required"   placeholder="专家手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">专家身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhuanjiaIdNumber" id="zhuanjiaIdNumber"  lay-verify="identity|required"   placeholder="专家身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">科室:</span>
                        <div class="layui-input-inline">
                            <select name="keshiTypes" id="keshiTypes" lay-filter="keshiTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">挂号费:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="guahaoMoney" id="guahaoMoney"  lay-verify="double|required"   placeholder="挂号费" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 邮箱 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhuanjiaEmail" id="zhuanjiaEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
