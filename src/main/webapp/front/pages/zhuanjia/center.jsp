    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhuanjiaName" id="zhuanjiaName" lay-verify="required" placeholder="专家姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhuanjiaPhone" id="zhuanjiaPhone"  lay-verify="required|phone"   placeholder="专家手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhuanjiaIdNumber" id="zhuanjiaIdNumber"  lay-verify="required|identity"   placeholder="专家身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="zhuanjiaPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="zhuanjiaPhoto" name="zhuanjiaPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="keshiTypes" id="keshiTypes">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="guahaoMoney" id="guahaoMoney"  placeholder="挂号费" autocomplete="off" class="layui-input" style="width: 500px">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhuanjiaEmail" id="zhuanjiaEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`zhuanjia/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#zhuanjiaPhotoImg").attr("src", data.data.zhuanjiaPhoto);
                });
