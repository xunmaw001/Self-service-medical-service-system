    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huanzheName" id="huanzheName" lay-verify="required" placeholder="患者姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huanzhePhone" id="huanzhePhone"  lay-verify="required|phone"   placeholder="患者手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huanzheIdNumber" id="huanzheIdNumber"  lay-verify="required|identity"   placeholder="患者身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="huanzhePhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="huanzhePhoto" name="huanzhePhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huanzheEmail" id="huanzheEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`huanzhe/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#huanzhePhotoImg").attr("src", data.data.huanzhePhoto);
                });
