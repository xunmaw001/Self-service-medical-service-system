...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //挂号费
            var guahaoMoneyCell = document.createElement('td');
            guahaoMoneyCell.innerHTML = item.guahaoMoney;
            row.appendChild(guahaoMoneyCell);


            //电子邮箱
            var zhuanjiaEmailCell = document.createElement('td');
            zhuanjiaEmailCell.innerHTML = item.zhuanjiaEmail;
            row.appendChild(zhuanjiaEmailCell);
