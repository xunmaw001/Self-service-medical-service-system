                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>科室</label>
                                    <input style="width: 450px" id="keshiValue" name="keshiValue" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="guahaoMoney" name="guahaoMoney" class="form-control"
                                               v-model="ruleForm.guahaoMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="zhuanjiaEmail" name="zhuanjiaEmail" class="form-control"
                                               v-model="ruleForm.zhuanjiaEmail" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.zhuanjiaContent != null && ruleForm.zhuanjiaContent != 'null' && ruleForm.zhuanjiaContent != '') {
            var zhuanjiaContentUeditor = UE.getEditor('zhuanjiaContentEditor');
                zhuanjiaContentUeditor.ready(function () {
                    ...
                    zhuanjiaContentUeditor.setDisabled('fullscreen');
            });
        }
    }
