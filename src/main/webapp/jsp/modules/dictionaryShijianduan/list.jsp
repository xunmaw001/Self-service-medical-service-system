            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">时间段管理</li>
                        <li class="breadcrumb-item active">时间段列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">时间段列表</h3>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="indexNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="时间段名称" aria-controls="tableId">
                                    </div>
                                </div>
...
<script>
    ...
    var tableName = "dictionaryShijianduan";
    var pageType = "list";
    var searchForm = {key: ""};
    var pageIndex = 1;
    var pageSize = 10;
    ...
    function getDataList() {
        http("dictionary/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            dicCode: "shijianduan_types",//编码名字
            dicName: "时间段",//汉字名字
