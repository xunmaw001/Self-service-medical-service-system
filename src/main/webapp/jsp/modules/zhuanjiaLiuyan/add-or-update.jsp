    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑专家留言</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">专家留言管理</li>
                        <li class="breadcrumb-item active">编辑专家留言</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">专家留言信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="huanzheId" name="huanzheId" type="hidden">
                                    <div class="form-group col-md-6 zhuanjiaLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="zhuanjiaLiuyanText" name="zhuanjiaLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("zhuanjiaLiuyan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addzhuanjiaLiuyan');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                zhuanjiaId: "required",
                huanzheId: "required",
                zhuanjiaLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                zhuanjiaId: "专家不能为空",
                huanzheId: "患者不能为空",
                zhuanjiaLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addzhuanjiaLiuyan = window.sessionStorage.getItem("addzhuanjiaLiuyan");
        if (addzhuanjiaLiuyan != null && addzhuanjiaLiuyan != "" && addzhuanjiaLiuyan != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("zhuanjiaLiuyan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#zhuanjiaLiuyanText").val(ruleForm.zhuanjiaLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#zhuanjiaLiuyanText').attr('readonly', 'readonly');
