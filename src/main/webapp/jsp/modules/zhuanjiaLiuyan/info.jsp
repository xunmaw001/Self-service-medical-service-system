            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">专家留言登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="huanzheId" name="huanzheId" v-model="ruleForm.huanzheId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>留言内容</label>
                                        <input style="width: 450px" id="zhuanjiaLiuyanText" name="zhuanjiaLiuyanText" class="form-control"
                                               v-model="ruleForm.zhuanjiaLiuyanText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "zhuanjiaLiuyan/info/" + id,
