                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 huanzheNameDiv">
                                        <label>患者姓名</label>
                                        <input style="width: 450px" id="huanzheName" name="huanzheName" class="form-control"
                                               placeholder="患者姓名">
                                    </div>
                                    <div class="form-group col-md-6 huanzhePhoneDiv">
                                        <label>患者手机号</label>
                                        <input style="width: 450px" id="huanzhePhone" name="huanzhePhone" class="form-control"
                                               onchange="huanzhePhoneChickValue(this)"  placeholder="患者手机号">
                                    </div>
                                    <div class="form-group col-md-6 huanzheIdNumberDiv">
                                        <label>患者身份证号</label>
                                        <input style="width: 450px" id="huanzheIdNumber" name="huanzheIdNumber" class="form-control"
                                               onchange="huanzheIdNumberChickValue(this)"  placeholder="患者身份证号">
                                    </div>
                                    <div class="form-group col-md-6 huanzhePhotoDiv">
                                        <label>患者头像</label>
                                    ...
                                    <div class="form-group col-md-6 huanzheEmailDiv">
                                        <label>电子邮箱</label>
                                        <input style="width: 450px" id="huanzheEmail" name="huanzheEmail" class="form-control"
                                               placeholder="电子邮箱">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                huanzhePhoto: "患者头像不能为空",
                sexTypes: "性别不能为空",
                huanzheEmail: "电子邮箱不能为空",
                // newMoney: "余额不能为空",
            }
        }).form();
    }
