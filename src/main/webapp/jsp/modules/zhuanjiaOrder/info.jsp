            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">专家挂号订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="zhuanjiaOrderUuidNumber" name="zhuanjiaOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.zhuanjiaOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>预约状态</label>
                                    <input style="width: 450px" id="zhuanjiaOrderYuyueValue" name="zhuanjiaOrderYuyueValue" class="form-control"
                                           v-model="ruleForm.zhuanjiaOrderYuyueValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "zhuanjiaOrder/info/" + id,
