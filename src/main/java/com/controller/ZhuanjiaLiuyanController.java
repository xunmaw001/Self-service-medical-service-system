    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhuanjiaLiuyan !=null){
            ...
            BeanUtils.copyProperties( zhuanjiaLiuyan , view );//把实体数据重构到view中
                ...
                //级联表
                HuanzheEntity huanzhe = huanzheService.selectById(zhuanjiaLiuyan.getHuanzheId());
                if(huanzhe != null){
    ...
    */
    ...
    public R save(@RequestBody ZhuanjiaLiuyanEntity zhuanjiaLiuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            zhuanjiaLiuyan.setHuanzheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            zhuanjiaLiuyanEntity.setHuanzheId(Integer.valueOf(data.get(0)));   //患者 要改的
